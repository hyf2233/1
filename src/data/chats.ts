...
export const presetChats: ChatSession[] = [
  {
    ...
    messages: [
      ...
      { id: 'msg3', role: 'user', content: '我想加入你的下一次探险', timestamp: Date.now() - 7200000 },
      {
        ...
        parsedTags: {
          maintext: '北边的遗迹最近很不安静，我正好需要一个人手。不过——我得先看看你的本事。\n\n明天正午，遗迹入口见。别迟到。',
          options: ['接受挑战，准时赴约', '先问清楚具体地点', '表示需要准备装备'],
        },
      },
    ],
  },
  {
    ...
    messages: [
      ...
      { id: 'msg7', role: 'user', content: '沉默之塔...没有印象', timestamp: Date.now() - 43200000 },
      {
        ...
        parsedTags: {
          maintext: '那就对了。知道它的人大多已经不在了。今晚在老地方见面，我会给你一些...参考资料。带点现金。',
          options: ['答应赴约', '询问"老地方"是哪里', '警惕地拒绝'],
        },
      },
    ],
  },
